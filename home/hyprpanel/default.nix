...
in {
  ...
  programs.hyprpanel = {
    ...
    settings = {
      ...
      menus.dashboard.powermenu.avatar.image = pkgs.fetchurl {
        url = "https://raw.githubusercontent.com/polowiper/Wallpapers/refs/heads/main/pfp.png";
        hash = "sha256-pzKh28vmyU54oTk9+Vy8iKbV0W5bgKxpJBmsBzjLciw=";
      };
      ...
      menus.dashboard.shortcuts.left.shortcut4.tooltip = "Rofi";
      ...
      menus.dashboard.directories.left.directory2.command = "thunar ${homeDir}/Documents";

      menus.dashboard.directories.left.directory3.label = "󰉍     Downloads";
      menus.dashboard.directories.left.directory3.command = "thunar ${homeDir}/Downloads";

      menus.dashboard.directories.right.directory1.label = "     Phone";
      menus.dashboard.directories.right.directory1.command = "thunar ${homeDir}/Phone";

      menus.dashboard.directories.right.directory2.label = "     Videos";
      menus.dashboard.directories.right.directory2.command = "thunar ${homeDir}/Videos";

      menus.dashboard.directories.right.directory3.label = "󰉏     Pictures";
      menus.dashboard.directories.right.directory3.command = "thunar ${homeDir}/Pictures";
