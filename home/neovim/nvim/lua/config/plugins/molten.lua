...
-- When Molten is initialized, set extra Quarto + Molten mappings
vim.api.nvim_create_autocmd("User", {
  pattern = "MoltenInitPost",
  callback = function()
    local r = require("quarto.runner")

    -- Quarto cell execution
    ...
    -- Tweak options for Python files
...
-- Autocmds to toggle visual tweaks based on filetype
...
-- Function to auto-init kernel from notebook metadata
